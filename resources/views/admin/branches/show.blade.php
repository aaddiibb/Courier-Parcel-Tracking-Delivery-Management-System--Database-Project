<x-admin-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Branch #{{ $branch->branch_id }}</h2>
            <div class="space-x-2">
                ...
                <a href="{{ route('admin.branches.index') }}" class="text-gray-600 hover:underline text-sm">Back</a>
            </div>
        </div>
    </x-slot>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <dl class="space-y-4">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $branch->branch_name }}</dd>
                    </div>
                    <div>
